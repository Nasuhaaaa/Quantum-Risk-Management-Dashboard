...
<div class="card-box">
    <form method="POST" action="{{ route('admin.pengurusan_sektor.update', $sector->id) }}">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('ketua_sektor') is-invalid @enderror"
                   id="ketua_sektor" name="ketua_sektor" value="{{ old('ketua_sektor', $sector->ketua_sektor) }}">
        ...
        <div class="mb-3">
            ...
            <textarea class="form-control @error('maklumat_perhubungan_sektor') is-invalid @enderror"
                      id="maklumat_perhubungan_sektor" name="maklumat_perhubungan_sektor" rows="3">{{ old('maklumat_perhubungan_sektor', $sector->maklumat_perhubungan_sektor) }}</textarea>
        ...
        <div class="mb-3">
            ...
            <textarea class="form-control @error('keterangan_sektor') is-invalid @enderror"
                      id="keterangan_sektor" name="keterangan_sektor" rows="4">{{ old('keterangan_sektor', $sector->keterangan_sektor) }}</textarea>
